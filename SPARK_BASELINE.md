...
## Watch Items
- **[NEW 2026-07-04 — Entry 098] Holo-3.1-35B-A3B — new A3B-class model on Arena today (NVFP4, 99.91 tok/s tg128 c1, vLLM single-node).** First appearance; no HF open weights confirmed. At 99.91 tok/s NVFP4 it is the second-highest NVFP4 vLLM single-node entry after Poveda's 118.91 for `nvidia/Qwen3.6-35B-A3B-NVFP4`. If FP8 open weights materialize, queue for eval. **Next check: July 7.**
