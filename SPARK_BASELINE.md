...
Last updated: 2026-07-07 (Entry 101 — spark-recon)
Last recon: 2026-07-07 (Entry 101)
...
| Field | Value |
|-------|-------|
| svd_last_checked_date | 2026-07-07 (Entry 101). dev764 confirmed still latest — no new build published July 7 (4 days stable). Prior: 2026-07-06 (Entry 100). dev764 confirmed still latest — no new build published July 6 (3 days stable). Prior: 2026-07-05 (Entry 099). dev764 confirmed still latest — no new build published July 5. Prior new build (Entry 098): **dev764 (`0.23.1rc1.dev764+g54b16d8a9.d20260703`, July 3 18:20 UTC) + FlashInfer `0.6.14-b5ac097e-d20260703`** — dev701→dev764 = +63 commits in 2 days; still v0.23.1rc1 base (no v0.24.x-based build — 5+ day lag past v0.24.0 June 29 release). **Arm C eval target: dev764 + FlashInfer 0.6.14** (supersedes dev701). Key dev764 changes: (a) `--reasoning-parser qwen3` added to `recipes/qwen3.6-35b-a3b-fp8.yaml` (issue #302 — flag was missing from production recipe; verify in prod docker-compose.yml); (b) **#46756 MIXED_PRECISION revert patch DROPPED** — upstream fix applied; patch removed from Dockerfile (note for Arm D NVFP4 eval protocol); (c) MiniMax M3 support (PRs #47445, #47392); (d) "Use prebuilt container by default." Prior dev701 (`0.23.1rc1.dev701+g00eb7cefa.d20260701`, July 1, FlashInfer `0.6.14-8fc7f079-d20260701`) superseded. Fallback pin: dev448 (`0.23.1rc1.dev448+ge53a17232.d20260625`, FlashInfer `0.6.13-25dd814e-d20260625`). PR #279 (DFlash + FP8 KV Cache): still OPEN. All other prior notes unchanged: gpu_memory_utilization default 0.7→0.8; CUDA base `nvidia/cuda:13.0.2-devel-ubuntu24.04`; MiniMax IPC fused path disabled (PR #43410); do not combine instanttensor with DFlash (issue #211). |

## Forum Tracking
| Field | Value |
|-------|-------|
| forum_last_checked_date | 2026-07-07 (Entry 101; WebSearch fallback; 719.json/721.json returns 403 in remote execution env) |
