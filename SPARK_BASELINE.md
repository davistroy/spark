...
| Field | Value |
|-------|-------|
| svd_last_checked_date | 2026-06-27 (Entry 090). **New wheel confirmed June 26: `0.23.1rc1.dev480+gd980a3cc6.d20260626`** (+32 commits vs dev448 in 1-day window). FlashInfer version unconfirmed (likely same 0.6.13 minor). **Arm C eval target updated dev448 → dev480.** dev448 key changes carry forward: (1) DeepGEMM switched to `nv_dev` branch; (2) DSV4F (MoE kernel) patch applied for broken vLLM PR #43008 — relevant to Qwen3.6-35B-A3B MoE dispatch on SM121. dev480 commit details inaccessible (GitHub 403/MCP scoping in remote env). dev448 reference: `0.23.1rc1.dev448+ge53a17232.d20260625`, FlashInfer `0.6.13-25dd814e-d20260625` (published 2026-06-25T20:38Z, +139 vs dev309). PR #279 (DFlash + FlashInfer FP8 KV Cache) still OPEN (no activity since June 12). All other prior notes unchanged: gpu_memory_utilization default 0.7→0.8; CUDA base `nvidia/cuda:13.0.2-devel-ubuntu24.04`; MiniMax IPC fused path disabled (PR #43410); do not combine instanttensor with DFlash (issue #211). |

## Forum Tracking
| Field | Value |
|-------|-------|
| forum_last_checked_date | 2026-06-27 (Entry 090; WebSearch fallback; 719.json returns 403 in remote execution env) |
