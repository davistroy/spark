...
| gemma4_pr_status | #39138 OPEN (needs-rebase; re-confirmed 2026-06-18) / #40099 OPEN (awaiting code-owner review; re-confirmed 2026-06-18). Both still required; unmerged in v0.23.0. |

## spark-vllm-docker Tracking
| Field | Value |
|-------|-------|
| svd_last_checked_date | 2026-06-18 (wheels rebuilt 2026-06-17: vLLM **0.23.1rc1.dev129+g2a47a9ff0.d20260617**, FlashInfer **0.6.13-d8f1dcbd-d20260617** — +76 dev commits since 2026-06-16 dev53. **DFlash + FlashInfer FP8 KV Cache recipe (PR #279) still OPEN** — not yet in wheels. instanttensor experimental load-format added (faster than fastsafetensors); issue #211 documents instanttensor+DFlash crash — do not combine. Prior (2026-06-16): vLLM 0.23.1rc1.dev53, FlashInfer 0.6.13-38feb62b-d20260615.) |

## Forum Tracking
| Field | Value |
|-------|-------|
| forum_last_checked_date | 2026-06-18 (WebSearch fallback; 719.json returns 403 in remote execution env) |
